...
require 'colorize'  
    def menu
        ...
        when "View adventure activities"
            ...
            sleep(2)
            activity_list = [{"activity_name" => "1. Harbour Bridge Climb", "date" => "21st December 2020"}, {"activity_name" => "2. Rollercoaster Zip Line", "date" => "31st December 2020", "availabilty" => "Sold Out!"},
